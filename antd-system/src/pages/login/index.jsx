            ...
            <div className="login-page">
                ...
                <div className="layer flex-center">
                    ...
                    <div className="logo-group">
                        <img className="avatar" src={require('../../assets/imgs/logo.png')} alt="logo"/>
                    </div>          
                        {/* 表单部分 */}
                        ...
                        <Form onSubmit={this.handleSubmit} className="login-form">
                            ...
                            <Form.Item>
                                {getFieldDecorator('code', {
                                    ...
                                    maxLength={4}
                                    addonAfter={<Spin spinning={this.state.captchaLoading} indicator={antIcon}>
                                        <div className="captcha" onClick={this.getNewCaptcha} dangerouslySetInnerHTML={{__html: this.state.captcha}}></div>
                                        </Spin>}
                                    />,
                                )}
                            </Form.Item>
                            <Form.Item>
                                <Button type="primary" htmlType="submit" className="button-login" >登录</Button>
                            </Form.Item>
                        </Form>
                    </Card>
                    </div>
